...
class PLCMonitorGUI:
    ...
    def create_widgets(self):
        ...
        self.refresh_entry.insert(0, "25")
    ...
    def update_data(self):
        try:
            ...
            if refresh_rate < 25: refresh_rate = 50 
        except ValueError:
            refresh_rate = 25
